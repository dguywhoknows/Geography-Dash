...
window.GEOGRAPHY_DASH = {
  citations: [
    // ── Cross-city liveability indices ─────────────────────────────────────────
    { label: "EIU Global Liveability Index 2024", url: "https://www.eiu.com/n/campaigns/global-liveability-index-2024" },
    { label: "Mercer Quality of Living City Ranking 2024", url: "https://www.mercer.com/en-ae/insights/total-rewards/talent-mobility-insights/quality-of-living-city-ranking/" },
    { label: "Numbeo Quality of Life Index 2024", url: "https://www.numbeo.com/quality-of-life/rankings.jsp" },
    { label: "OECD Well-being Data Monitor 2025", url: "https://www.oecd.org/en/data/tools/well-being-data-monitor.html" },
    { label: "EIU Safe Cities Index 2024", url: "https://safecities.economist.com/" },
    { label: "World Justice Project — Rule of Law Index 2024", url: "https://worldjusticeproject.org/rule-of-law-index/" },
    { label: "Transparency International — Corruption Perceptions Index 2024", url: "https://www.transparency.org/en/cpi/2024" },
    { label: "TomTom Global Traffic Index 2023", url: "https://www.tomtom.com/traffic-index/ranking/" },
    { label: "IQAir World Air Quality Report 2023", url: "https://www.iqair.com/world-air-quality-report" },
    { label: "UN-Habitat Global Urban Data", url: "https://unhabitat.org/" },
    { label: "World Bank — Urban Development", url: "https://www.worldbank.org/ext/en/topic/urban-development" },
    { label: "World Health Organization", url: "https://www.who.int/" },
    { label: "UNESCO Institute for Statistics", url: "https://uis.unesco.org/en" },
    { label: "Reporters Without Borders — Press Freedom Index 2024", url: "https://rsf.org/en/index" },
    // ── Copenhagen ─────────────────────────────────────────────────────────────
    { label: "City of Copenhagen — Cycling Statistics 2022", url: "https://cycling-embassy.dk/2023/06/21/the-city-of-copenhagen-cycling-statistics-2022/" },
    { label: "Statistics Denmark (Danmarks Statistik)", url: "https://www.dst.dk/en" },
    { label: "Copenhagen Climate Plan 2025 → 2030 Update", url: "https://www.kk.dk/en/green-copenhagen/copenhagen-climate-plan" },
    { label: "Denmark — Agency for Digital Government (MitID / e-government)", url: "https://en.digst.dk/" },
    { label: "Danish Arts Foundation — Annual Report", url: "https://www.kunst.dk/english/" },
    { label: "Roskilde Festival — About (non-profit model)", url: "https://www.roskilde-festival.dk/en/about/" },
    { label: "Danish Agency for Higher Education — SU Living Grant", url: "https://www.ug.dk/uddannelser/universitetsuddannelser/oekonomi-og-tilskud/su" },
    { label: "Copenhagen Metro (Metroselskabet) — Network & Ridership", url: "https://www.m.dk/english/" },
    { label: "Danish Health Authority (Sundhedsstyrelsen) — Mental Health Reports", url: "https://www.sst.dk/en" },
    { label: "OECD Health Statistics — Denmark", url: "https://www.oecd.org/en/data/datasets/oecd-health-statistics.html" },
    { label: "Landsbyggefonden — Danish Non-Profit Social Housing Fund", url: "https://www.lbf.dk/" },
    { label: "Boligsiden — Danish Housing Market Statistics", url: "https://www.boligsiden.dk/" },
    { label: "Danish Ministry of Taxation — Top Tax Rate", url: "https://www.skm.dk/english/" },
    { label: "Copenhagen Design Week — Official Statistics", url: "https://www.copenhagendesignweek.com/" },
    { label: "Movia / Copenhagen Electric Harbour Buses", url: "https://www.moviatrafik.dk/om-movia/english" },
    // ── Cross-city additional sources ──────────────────────────────────────────
    { label: "OECD PISA — Programme for International Student Assessment", url: "https://www.oecd.org/en/about/programmes/pisa.html" },
    { label: "OECD Better Life Index — Work-Life Balance", url: "https://www.oecdbetterlifeindex.org/topics/work-life-balance/" },
    { label: "ILO — International Labour Organization (informal economy data)", url: "https://www.ilo.org/global/topics/employment-promotion/informal-economy/lang--en/index.htm" },
    { label: "WHO — Global Status Report on Road Safety 2023", url: "https://www.who.int/publications/i/item/9789241565684" },
    // ── Toronto ────────────────────────────────────────────────────────────────
    { label: "Toronto Community Housing — Annual Reports", url: "https://www.torontohousing.ca/annual-reports" },
    { label: "TTC — 15-Year Capital Investment Plan", url: "https://www.ttc.ca/about-the-ttc/transit-planning/15-year-capital-investment-plan" },
    { label: "City of Toronto Open Data Portal", url: "https://open.toronto.ca/" },
    { label: "EQAO — Education Quality and Accountability Office", url: "https://www.eqao.com/" },
    { label: "TomTom Traffic Index 2023 — Toronto", url: "https://www.tomtom.com/traffic-index/toronto-traffic/" },
    { label: "Toronto Police Services — Annual Statistical Report", url: "https://www.tps.ca/organizational-chart/statistics/" },
    { label: "TRREB — Toronto Regional Real Estate Board Market Reports", url: "https://trreb.ca/market-news/market-stats/" },
    { label: "Statistics Canada — Toronto Income & Demographics", url: "https://www12.statcan.gc.ca/census-recensement/2021/as-sa/index-eng.cfm" },
    { label: "Centre for Addiction and Mental Health (CAMH) — Ontario Data", url: "https://www.camh.ca/en/driving-change/the-crisis-is-real/mental-health-statistics" },
    { label: "City of Toronto — 10-Year Capital Plan (Infrastructure)", url: "https://www.toronto.ca/city-government/budget-finances/city-budget/" },
    { label: "Toronto Region Conservation Authority (TRCA) — Ravine System", url: "https://trca.ca/" },
    // ── Istanbul ───────────────────────────────────────────────────────────────
    { label: "KOERI — Kandilli Observatory & Earthquake Research Institute", url: "http://www.koeri.boun.edu.tr/sites/1/index.html" },
    { label: "Istanbul Metropolitan Municipality (IBB) Open Data", url: "https://data.ibb.gov.tr/en/" },
    { label: "TomTom Traffic Index 2023 — Istanbul", url: "https://www.tomtom.com/traffic-index/istanbul-traffic/" },
    { label: "World Bank — Turkey Urban Development", url: "https://www.worldbank.org/en/country/turkey/overview" },
    { label: "TUIK — Turkish Statistical Institute (inflation, income, housing)", url: "https://www.tuik.gov.tr/Home/Index" },
    { label: "ISKI — Istanbul Water and Sewerage Administration", url: "https://en.iski.istanbul/" },
    { label: "IKSV — Istanbul Foundation for Culture and Arts (Biennial)", url: "https://iksv.org/en" },
    { label: "UN Women — Turkey: Ending Violence Against Women", url: "https://turkey.unwomen.org/en" },
    { label: "ILO — Turkey Labour Market Reports", url: "https://www.ilo.org/ankara/lang--en/index.htm" },
    { label: "Turkish Central Bank (TCMB) — Exchange Rate Data", url: "https://www.tcmb.gov.tr/wps/wcm/connect/EN/TCMB+EN/" },
    // ── Bangkok ────────────────────────────────────────────────────────────────
    { label: "IQAir — Bangkok Air Quality Data 2024", url: "https://www.iqair.com/thailand/bangkok" },
    { label: "TomTom Traffic Index 2023 — Bangkok", url: "https://www.tomtom.com/traffic-index/bangkok-traffic/" },
    { label: "Asian Development Bank — Thailand Urban Development", url: "https://www.adb.org/countries/thailand/sector/urban-development" },
    { label: "Bank of Thailand — Economic Data", url: "https://www.bot.or.th/en/" },
    { label: "NHSO — National Health Security Office Thailand (30-Baht Scheme)", url: "https://eng.nhso.go.th/" },
    { label: "BTS Group Holdings — Skytrain Ridership Statistics", url: "https://www.bts.co.th/eng/index.aspx" },
    { label: "Bangkok Metropolitan Administration — Urban Planning", url: "https://www.bangkok.go.th/lang/en" },
    { label: "ILO — Thailand Informal Economy Reports", url: "https://www.ilo.org/asia/countries/thailand/lang--en/index.htm" },
    { label: "Thai Department of Disease Control — Dengue Surveillance", url: "https://ddc.moph.go.th/en/" },
    { label: "Department of Disaster Prevention and Mitigation Thailand — Flood Data", url: "https://www.disaster.go.th/en/" },
    // ── New Delhi ──────────────────────────────────────────────────────────────
    { label: "IQAir — New Delhi Air Quality 2023 (World's Most Polluted Capital)", url: "https://www.iqair.com/india/delhi" },
    { label: "Delhi Metro Rail Corporation — Phase 4 Progress", url: "https://www.delhimetrorail.com/" },
    { label: "ASER India 2023 — Annual Status of Education Report", url: "https://asercentre.org/" },
    { label: "World Bank — India Urban Overview", url: "https://www.worldbank.org/en/country/india/overview" },
    { label: "Election Commission of India — Voter Turnout Data", url: "https://www.eci.gov.in/" },
    { label: "NASSCOM — India Tech Industry Report 2024", url: "https://nasscom.in/knowledge-center/publications" },
    { label: "Central Pollution Control Board India — Delhi Air Quality", url: "https://cpcb.nic.in/" },
    { label: "Centre for Science and Environment India — Urban Reports", url: "https://www.cseindia.org/" },
    { label: "Delhi Development Authority (DDA) — Housing Reports", url: "https://dda.gov.in/" },
    { label: "Ministry of Road Transport & Highways India — Road Accident Report", url: "https://morth.nic.in/road-accident-in-india" },
    { label: "IIT Delhi — QS World University Rankings Profile", url: "https://www.iitd.ac.in/" },
    // ── Lagos ──────────────────────────────────────────────────────────────────
    { label: "Lagos State Government — Budget & Economic Planning", url: "https://mepb.lagosstate.gov.ng/" },
    { label: "Lagos Rail Mass Transit — Blue Line", url: "https://lagosrailmasstransit.com/" },
    { label: "UN-Habitat — Lagos City Overview", url: "https://unhabitat.org/nigeria" },
    { label: "World Bank — Nigeria Urban Development", url: "https://www.worldbank.org/en/country/nigeria/overview" },
    { label: "National Film and Video Censors Board (Nollywood data)", url: "https://nfvcb.gov.ng/" },
    { label: "UNICEF Nigeria — Out-of-School Children 2023", url: "https://www.unicef.org/nigeria/education" },
    { label: "National Bureau of Statistics Nigeria — Labour Force Survey", url: "https://www.nigerianstat.gov.ng/" },
    { label: "Lagos Waste Management Authority (LAWMA) — Waste Data", url: "https://lawma.gov.ng/" },
    { label: "Amnesty International — Nigeria: #EndSARS and Police Brutality", url: "https://www.amnesty.org/en/location/africa/west-and-central-africa/nigeria/" },
    { label: "Nigerian Medical Association — Doctor-Patient Ratio Reports", url: "https://www.nma.com.ng/" },
    { label: "Lagferry — Lagos Ferry Services", url: "https://lagferry.com/" },
    { label: "Lagos State Environmental Protection Agency (LASEPA)", url: "https://lasepa.gov.ng/" },
  ],
  controls:
